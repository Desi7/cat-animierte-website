    ...
    return (
        <div>
            <svg width="300" height="300" xmlns="http://www.w3.org/2000/svg" viewBox="-250 -250 500 500">
                ...
                <g>
                    <polygon transform="translate(-250 -295)" points="180,200 165,250 205,220 155,220 195,250"
                             fill="orange"/>
                    <polygon transform="translate(-250 -295)" points="250,200 235,250 275,220 225,220 265,250"
                             fill="orange"/>
                    <animateTransform
